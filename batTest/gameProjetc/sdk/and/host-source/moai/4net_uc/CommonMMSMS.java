		...
		CommonLog.d("commonSdk", "MMIniting .....");
 		 ...
 		 new Handler(Looper.getMainLooper()).post(new Runnable() {
 			...
 			try {
 				...
 				appId=GetJsonVal(sConfigJsonObject,"appid","0");
 				appKey=GetJsonVal(sConfigJsonObject,"appkey","0");
 				
 				try {
 					 Log.e("fuck","appid---->"+appId);
 			 		  Log.e("fuck","appkey---->"+appKey);
            ...
            yuan = price/100;
         	...
         	new Handler(Looper.getMainLooper()).post(new Runnable() {
     			...
     			try {
     	            ...
     	            String ProName = GetJsonVal(payinfoJson,"name","礼包");
     	            
     	            
     	            CommonUC.ucPay(ProName,String.valueOf(yuan),payCode_,orderParms);
