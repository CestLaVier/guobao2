...
void onLoding_DX(Bundle savedInstanceState){
	...
	public void getChannelId(){
		...
		if(isMM){MM_And = 2; CommonBaseSdk.configFileName=String.format("cConfig_%d.json", 3); CommonLog.d("isMM", "true");}
		else  {MM_And = 1; CommonBaseSdk.configFileName=String.format("cConfig_%d.json", 3);   CommonLog.d("isMM", "false");}
